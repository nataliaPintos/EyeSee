...
import {
    FontAwesome, MaterialIcons, Ionicons, Feather
                ...
                <View style={[style.parent]}>
                    <TouchableOpacity style={[style.child, {backgroundColor: '#0b4b5e', flex: 0.6}]}>
                        ...
                        <View style={{
                            ...
                            <Text style={{color: 'white', fontSize: 18}}>Deficientes
                                Visuais: {this.state.blind.usuarios} </Text>
                            <Text style={{
                                color: 'white',
                                fontSize: 18
                            }}>Voluntários: {this.state.noBlind.usuarios}  </Text>
                    ...
                    <TouchableOpacity style={[style.child, {backgroundColor: '#F0F0F0', flex: 0.2}]} onPress={() =>
                        ...
                        <Text style={{color: 'grey', fontSize: 15, padding: 10}}>Você receberá uma notificação quando
                            alguém precisar de ajuda!</Text>
