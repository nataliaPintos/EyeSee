              ...
              <View style={styles.container}>
                <View style= {{margin:10}}>
                    ...
                    <TextInput style= {styles.inputBox} placeholder='Senha atual' 
                      onChangeText={(senha) => this.setState({senha})} secureTextEntry={true}  autoCapitalize="none"/>
                    <TextInput style= {styles.inputBox} placeholder='Nova senha'
                      onChangeText={(password) => this.setState({password})} secureTextEntry={true} autoCapitalize="none"/>
                    <TextInput style= {styles.inputBox} placeholder='Confirmar nova senha' secureTextEntry={true}   autoCapitalize="none"/>
